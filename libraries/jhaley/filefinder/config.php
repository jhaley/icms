 ...
 */
define( '_JHAEXEC', 1 );
define('JHA_BASE_PATH', dirname('../../../../../../index.php'));
define( 'DS', DIRECTORY_SEPARATOR );

require_once JHA_BASE_PATH . DS .'includes/defines.php';
require_once JHA_BASE_PATH . DS .'includes/imports.php';

$configuration = JhaFactory::getConfig();
...
$baseUrl = $configuration->site . 'images/uploads/';
